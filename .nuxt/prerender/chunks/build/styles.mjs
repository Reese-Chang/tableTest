...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.h6GFmlpu.mjs').then(interopDefault),
  "pages/productForm.vue": () => import('./productForm-styles.CUcZRywD.mjs').then(interopDefault),
  "plugins/element-plus.ts": () => import('./entry-styles.h6GFmlpu.mjs').then(interopDefault),
  "pages/productForm.vue?vue&type=style&index=0&lang.css": () => import('./productForm-styles.BaOu9fdz.mjs').then(interopDefault),
